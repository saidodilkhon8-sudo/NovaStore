    ...
    <div className="min-h-screen flex items-center justify-center pt-16 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-secondary-text mt-1">{t("login.subtitle")}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6 rounded-2xl bg-surface border border-border">
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5 text-secondary-text">{t("login.email")}</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5 text-secondary-text">{t("login.password")}</label>
            <input
              type="password"
              value={password}
